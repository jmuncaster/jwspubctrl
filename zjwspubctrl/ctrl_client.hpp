...
namespace zjwspubctrl {
  ...
  class CtrlClient {
    public:
      CtrlClient(const jws::json& ctrl_request_schema, const jws::json& ctrl_reply_schema, const std::string& server_address = zpubctrl::default_host, int ctrl_port = zpubctrl::default_ctrl_port);
      ~CtrlClient();
